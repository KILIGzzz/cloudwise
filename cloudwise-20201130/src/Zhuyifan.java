 ...
 * @author ：IvanZ
 * @version : 1.0
 * @date ：Created in 2020/11/30 8:58
 * @description ：
 * @modified By：
 */
public class Zhuyifan {
 ...
 * @param resultSet:
    ...
    public static void main(String[] args) {
        ...
        List<Map<String, Object>> list = Zhuyifan.executeQuery(sql);
